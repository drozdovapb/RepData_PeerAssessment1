...
```
Mean number of steps per day is `r meanSteps`.
Median number of steps per day is `r medianSteps`.
...
The number of rows with NA values in `r naSum`. That's pretty much.
...
Mean number of steps per day is `r meanStepsNoNa`.
Median number of steps per day is `r medianStepsNoNa`.
